    ...
    return (
        <header id='header' role='banner'>
            ...
            <div className='header__sns'>
                <ul>
                    <li>
                        <a href='https://github.com/06shelk' rel='noopener noreferrer'>
                            <AiFillGithub />
                        </a>
                    </li>
                    <li>
                        <a href='https://seolstudy.tistory.com' rel='noopener noreferrer'>
                            <FaBlogger />
                        </a>
                    </li>
                    <li>
                        <a href='https://www.instagram.com/tjfghk_06' rel='noopener noreferrer'>
                            <AiOutlineInstagram />
                        </a>
                    </li>
                </ul>
